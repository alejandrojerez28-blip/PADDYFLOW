...
import { listRouter as priceRulesListRouter } from './routes/supplierPriceRules.js';
import supplierSettlementsRoutes from './routes/supplierSettlements.js';
...
app.use('/api/price-rules', priceRulesListRouter);
app.use('/api/supplier-settlements', supplierSettlementsRoutes);
